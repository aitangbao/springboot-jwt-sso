package com.aitangbao.sso.controller;
...
import com.aitangbao.sso.util.JwtUtils;
...
public class SsoCheck {
    ...
    public Result<Map<String,Object>> checkLogin (String username, String password) {
        ...
        if (user != null) {
            ...
            String cookieValue = JwtUtils.geneJsonWebToken(user);
    ...
    public boolean checkAuthCookies (String cookieName, String cookieValue) {
        Claims claims = JwtUtils.checkJWT(cookieValue);
